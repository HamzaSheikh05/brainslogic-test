...
export default function Home() {
  return (
    <>
      <section className="flex h-[812px] bg-video-img bg-cover bg-no-repeat box-border items-end py-8">
      ...
      <section className="flex flex-row justify-center items-start py-12 bg-navigation h-[216px]">
